...
public class SignUpAdminTest {
    ...
    public void signUpAdminTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.firstnameEditText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("System"), closeSoftKeyboard());

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.firstnameEditText), withText("System"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.loginTable),
                                        2),
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.lastnameEditText), withText("Admin"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.loginTable),
                                        3),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.clerkLoginBtn), withText("Sign up as Clerk"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.loginTable),
                                        7),
